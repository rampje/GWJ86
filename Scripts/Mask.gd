...
const MASK_TYPES := ["Sight", "Movement","Attack","Wisdom","Lightness","Companionship","Movement #2","Time"]

@export_enum("Sight", "Movement","Attack","Wisdom","Lightness","Companionship","Movement #2","Time") var mask_type: String = "Sight"
